...
create_clock -period 50.0 -name SWCLK [get_ports {DAPLink_tri_o[15]}]
...
# QSPI Q[3:0] & CS
set_input_delay  -clock [get_clocks dap_qspi_clk] -max -add_delay 8.5 [get_ports {{DAPLink_tri_o[4]} {DAPLink_tri_o[5]} {DAPLink_tri_o[6]} {DAPLink_tri_o[7]} {DAPLink_tri_o[10]}}]
set_input_delay  -clock [get_clocks dap_qspi_clk] -min -add_delay 2.0 [get_ports {{DAPLink_tri_o[4]} {DAPLink_tri_o[5]} {DAPLink_tri_o[6]} {DAPLink_tri_o[7]} {DAPLink_tri_o[10]}}]

set_output_delay -clock [get_clocks dap_qspi_clk] -max -add_delay 2.0 [get_ports {{DAPLink_tri_o[4]} {DAPLink_tri_o[5]} {DAPLink_tri_o[6]} {DAPLink_tri_o[7]} {DAPLink_tri_o[10]}}]
set_output_delay -clock [get_clocks dap_qspi_clk] -min -add_delay -2.5 [get_ports {{DAPLink_tri_o[4]} {DAPLink_tri_o[5]} {DAPLink_tri_o[6]} {DAPLink_tri_o[7]} {DAPLink_tri_o[10]}}]
...
# CS
set_output_delay -clock [get_clocks dap_spi_clk] -max -add_delay 2.0 [get_ports {DAPLink_tri_o[0]}]
set_output_delay -clock [get_clocks dap_spi_clk] -min -add_delay -2.5 [get_ports {DAPLink_tri_o[0]}]

# MISO
set_input_delay  -clock [get_clocks dap_spi_clk] -max -add_delay 8.5 [get_ports {DAPLink_tri_o[1]}]
set_input_delay  -clock [get_clocks dap_spi_clk] -min -add_delay 2.0 [get_ports {DAPLink_tri_o[1]}]

# MOSI
set_output_delay -clock [get_clocks dap_spi_clk] -max -add_delay 2.0 [get_ports {DAPLink_tri_o[2]}]
set_output_delay -clock [get_clocks dap_spi_clk] -min -add_delay -2.5 [get_ports {DAPLink_tri_o[2]}]
...
set_input_delay  -clock [get_clocks SWCLK] -add_delay -max 42.0 [get_ports {DAPLink_tri_o[14]}]
set_input_delay  -clock [get_clocks SWCLK] -add_delay -min -1        [get_ports {DAPLink_tri_o[14]}]
set_output_delay -clock [get_clocks SWCLK] -add_delay -max 5      [get_ports {DAPLink_tri_o[14]}]
set_output_delay -clock [get_clocks SWCLK] -add_delay -min -5       [get_ports {DAPLink_tri_o[14]}]
...
set_input_delay  -clock [get_clocks slow_out_clk] -add_delay 0.5 [get_ports {DAPLink_tri_o[12]}]
set_output_delay -clock [get_clocks slow_out_clk] -add_delay 0.5 [get_ports usb_uart_txd]
set_output_delay -clock [get_clocks slow_out_clk] -add_delay 0.5 [get_ports {DAPLink_tri_o[11]}]
...
# DAPLink_fitted
set_input_delay  -clock [get_clocks slow_out_clk] -add_delay 0.5 [get_ports {DAPLink_tri_o[8]}]
# nSRST
set_input_delay  -clock [get_clocks slow_out_clk] -add_delay 0.5 [get_ports {DAPLink_tri_o[13]}]
